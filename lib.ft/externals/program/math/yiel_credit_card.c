...
int main(void)
{
    ...
    //the name of the card you need to compare
    // worth's value of each dollar spent on each cards
    // the fees of the credit card
    // perhaps create an array to hold the different offer that might benefit the customer.
    char input[50];
    char offer[50];
